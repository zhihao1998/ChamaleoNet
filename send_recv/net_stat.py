...
def mon_net_speed():
    ...
    net_stat_log_fp.write("time,bits_sent,bits_recv,packets_sent,packets_recv,mem_usage,cpu_num,cpu_usage\n")
    ...
    while True:
        ...
        net_stat_log_fp.write(f"{time.time()},{diff[0]},{diff[1]},{diff[2]},{diff[3]},{mem_usage},{cpu_num},{cpu_usage}\n")
        ...
        print(f"mem_usage: {unit_conversion(mem_usage)} | cpu_num: {cpu_num}, cpu_usage: {cpu_usage}%")
