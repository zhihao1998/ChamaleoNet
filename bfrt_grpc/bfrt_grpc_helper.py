...
class BfRtAPI:
    ...
    def __init__(self, grpc_addr='localhost:50052',
        ...
        self.bfrt_info = None
        # gc.Notifications(enable_idletimeout=True, enable_entry_active=False, enable_port_status_change=False, enable_learn=False)
    ...
    def entry_add(self, table_name, keys=[], data=[], action_name=None):
        ...
        Args:
            ...
            keys (list)              : List of tuples ``(key_name, key_value, key_mask)``
